...
class AuthAPI:
    ...
    def login(self, username: str, password: str) -> Dict[str, Any]:
        ...
        Returns:
            dict: Login response with user and session token information
    ...
    def logout(self) -> Dict[str, Any]:
        ...
        return self.client._make_request(
            "POST",
            "/api/auth/sign-out",
            headers={"Origin": self.client._get_trusted_origin()}
        )
    ...
    def get_me(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: Current session and user information

        Example:
            >>> session = client.auth.get_me()
            >>> print(session['user']['username'])
        """
        return self.client._make_request("GET", "/api/auth/get-session")
